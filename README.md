...
当前版本：**1.0.9**。也可以前往 [Latest Release](https://github.com/ch998244353/TuckPane/releases/latest) 查看完整发布说明。

- [TuckPane-1.0.9-win-x64-setup.exe](https://github.com/ch998244353/TuckPane/releases/download/v1.0.9/TuckPane-1.0.9-win-x64-setup.exe)：离线安装器，无需管理员权限，自动创建桌面快捷方式。
- [TuckPane-1.0.9-win-x64-portable.zip](https://github.com/ch998244353/TuckPane/releases/download/v1.0.9/TuckPane-1.0.9-win-x64-portable.zip)：解压后双击 `00-启动 TuckPane.exe`。
- [SHA256SUMS.txt](https://github.com/ch998244353/TuckPane/releases/download/v1.0.9/SHA256SUMS.txt)：下载文件的 SHA-256 校验值。
